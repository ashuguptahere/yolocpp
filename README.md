...
| **yolo11** | 2024 | **Ultralytics (official)**                 | Refined CSP: C3k2 (kernel-tunable C3) + C2PSA (position-sensitive attention); same v8 Detect head | 🟡 stub — plan: reuse v8 head, swap backbone+neck. 5 scales × 5 tasks |
