...
| #46F2 | Migrate `engine::run_benchmark` per-version dispatch in `engine/benchmark.cpp::bench_pt` to the registry (`benchmark_pt` adapter hook). 11 cases of the same load-and-time pattern. | — | within #46 | — |
